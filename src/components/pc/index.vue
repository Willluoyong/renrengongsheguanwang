<template>
  <el-container style="min-width: 1300px" id="index">
    <el-header>
      ...
      <div class="theme"></div>
      <p class="introduce">一个基于区块链技术的共享生态社区</p>
      <div class="characteristic"></div>
      <div class="feature_box">
        <ul>
          <li>交易所</li>
          <li>共享矿池</li>
          <li><router-link to="/machineMall">云算力商城</router-link></li>
          <li>资产托管</li>
          <li>电子竞技</li>
        </ul>
        <ul>
      ...
      <a class="load_point" @click="loading" ></a>
      <div class="erweima_wrapper">
        <p  style="" @mouseenter="enter" @mouseleave="leave">扫码下载到手机</p>
        <img :src="urlCode" class="erweima" v-show="erweima_state"/>
      </div>
    ...
    <el-main style="overflow-x: hidden">
      <div class="working_title">
        <span>项目发起</span>
        <span class="roundness_icon"></span>
        <span>合作媒体</span>
      </div>
      <div class="company"></div>
    </el-main>
    <!--尾部-->
    <el-footer class="el-bc">
      <div class="icon_box"><a></a><a></a><a></a><a></a></div>
      <div class="email_box"><span></span><p>business@cococo.org</p></div>
      <p class="copyright">© Everyone chain commune, 2018. All Rights Reserved.</p>
    </el-footer>
  </el-container>
</template>
  ...
  *{
  ...
  .el-header{
    ...
    .home_choose{
      width: 30px;
      height: 28px;
      background: url("../../assets/pc/icon_home_normal@2x.png") no-repeat center;
      background-size: cover;
    }
    .rail_colourless{
      border-bottom: none;
    ...
    .introduce{
      ...
      background:linear-gradient(-90deg,rgba(207,113,241,1) 0%, rgba(69,104,232,1) 100%);
    ...
    .load_point{
      ...
      height: 166px;
      /*line-height: 166px;*/
      background: url("../../assets/pc/btn_download_normal@2x.png")no-repeat center;
      background-size: 100% auto;
    }
    .load_point:hover{
      background: url("../../assets/pc/btn_download_hover@2x.png")no-repeat center;
      background-size: 100% auto;
    }
    /*.load_state{*/
      /*!*display: block;*!*/
  ...
  .el-main{
    ...
    .working_title{
      ...
      width: 624px;
      height: 78px;
      background: url("../../assets/pc/company_title_bg@2x.png") no-repeat center;
      background-size: 100% 100%;
      display: flex;
      flex-direction: row;
      justify-content: center;
    ...
    .company{
      ...
      background: url("../../assets/pc/company@2x.png") no-repeat center;
      background-size: 100% 100%;
      margin-top: 32px;
    }
