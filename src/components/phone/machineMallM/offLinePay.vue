<template>
    <div id="offLinePay" >
        ...
        <div class="card_info">
            ...
            <div class="name_cardId"><span>{{cardholder}}</span><span class="bank_cardNo" id="bank_cardNo">{{bankCardNo}}</span><span class="copy_card" @click="copyCardNO">复制卡号</span></div>
            <div class="address">{{address}}</div>
            <div class="randomCode">{{referenceNum}}</div>
...
export default {
    ...
    methods:{
        ...
        copyCardNO(){
            let copyHttp = document.querySelector('#bank_cardNo');
...
body{
    ...
    .card_info{
        width: 9.42rem;
        height: 4.85rem;
        background:url("../../../assets/phone/pic_miner_bank_bg.png") no-repeat center;
        background-size: cover;
        ...
        .bank_container{
            ...
            .bank_icon{
                ...
                width:0.39rem;
                height:0.39rem;
                background: url("../../../assets/phone/icon_payment_bankcard.png") no-repeat;
                background-size: cover;
                margin-left: 0.79rem; 
                margin-top: 0.61rem; 
