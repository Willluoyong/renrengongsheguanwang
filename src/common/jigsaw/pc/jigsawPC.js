(function (window) {
  ...
  function createBlockImg(onload) {
    ...
    img2.onload = onload
    img2.onerror = () => {
      console.log(sessionStorage.getItem('blockImage'));
    }
  ...
  class jigsaw {
    ...
    initDOM() {
      ...
      sliderContainer.className = 'sliderContainerPC'
      refreshIcon.className = 'refreshIconPC'
      sliderMask.className = 'sliderMaskPC'
      slider.className = 'sliderPC'
    ...
    initImg() {
      ...
      const img2 = createBlockImg(() =>{
        this.blockCtx.drawImage(img2, 0, 0,60,203)
        const y = this.y - r * 2 + 2
        // const ImageData = createBlockImg();
        // this.blockCtx.putImageData(ImageData, 0, y)
      })
    ...
    bindEvents() {
      ...
      document.addEventListener('mousemove', (e) => {
        ...
        addClass(this.sliderContainer, 'sliderContainerPC_active')
    ...
    reset() {
      this.sliderContainer.className = 'sliderContainerPC'
